    ...
    class Episodes
      ...
      def self.rebuild_entity(db_record)
        ...
        Entity::Episode.new(id: db_record.id, origin_id: db_record.origin_id, name: db_record.name,
                            ...
                            release_date: db_record.release_date, type: db_record.type, episode_url: db_record.episode_url,
                            episode_mp3_url: db_record.episode_mp3_url, podcast_length: db_record.podcast_length,
                            transcript: db_record.transcript, sentence_segments: db_record.sentence_segments,
                            translation: db_record.translation, difficulty_score: db_record.difficulty_score,
                            word_dict: db_record.word_dict, difficult_words: db_record.difficult_words,
                            moderate_words: db_record.moderate_words, easy_words: db_record.easy_words)
      end
